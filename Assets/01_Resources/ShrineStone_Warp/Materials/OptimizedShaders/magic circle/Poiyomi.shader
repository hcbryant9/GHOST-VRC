Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/427515499c7846e4e96d8f857e758075"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				edgeAlpha = 0;
				[flatten]
				switch((3.0 /*_DissolveType*/))
				{
					default: // Basic (case 1)
					{
						da = remap(da, 0, 1, -(0.041 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.041 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.041 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.041 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.041 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.041 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
					...
					case 4: // CenterOut
					{
						...
						float noise;
						[flatten]
						switch((2.0 /*_CenterOutDissolveMode*/))
						{
							...
							{
								ramp = dot(normalize(float4(0,0,10,0)), lerp(poiMesh.normals[0], poiMesh.normals[1], (0.0 /*_CenterOutDissolveNormals*/)));
						...
						if((0.1 /*_CenterOutDissolvePower*/) != 1)
						{
							ramp = pow(ramp, (0.1 /*_CenterOutDissolvePower*/));
						}
				...
				if ((0.041 /*_DissolveEdgeWidth*/) || ((3.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0.1307401,1,0.1269953,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0.1307401,1,0.1269953,1).a);
					#ifndef POI_SHADOW
					...
					#endif
					poiFragData.baseColor = lerp(poiFragData.baseColor, edgeColor.rgb, smoothstep(0, 1 - (0.692 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				}
				poiFragData.emission += lerp(0, dissolveToTexture * (3.66 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (5.69 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.692 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				switch((1.0 /*_MatcapUVMode*/))
				{
					case 0:
					{
						...
						matcapUV = noSknewViewNormal.rg * (0.82 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 1:
					{
						...
						matcapUV = float2(dot(worldViewRight, normal0), dot(worldViewUp, normal0)) * (0.82 /*_MatcapBorder*/) + 0.5;
						break;
					}
					case 2:
					{
						...
						matcapUV = uv * (0.82 /*_MatcapBorder*/) + 0.5;
						break;
					}
				}
				matcapUV = lerp(matcapUV, poiMesh.uv[(4.0 /*_MatcapUVToBlend*/)], float4(0,0,0,0).xy);
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					{
						#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
						matcapSmoothness *= POI2D_SAMPLER_PAN(_MatcapMask, _MainTex, poiUV(poiMesh.uv[(6.0 /*_MatcapMaskUV*/)], float4(1,1,0,0)), float4(-3,3,0,0))[(3.0 /*_MatcapMaskSmoothnessChannel*/)];
						#endif
					}
				...
				if ((0.0 /*_MatcapSmoothnessEnabled*/))
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(0.005181514,1,0.7363394,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.005181514,1,0.7363394,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(0.005181514,1,0.7363394,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.005181514,1,0.7363394,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(0.005181514,1,0.7363394,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(0.005181514,1,0.7363394,1).a);
				#endif
				matcap.rgb *= (2.98 /*_MatcapIntensity*/);
				matcap.rgb = lerp(matcap.rgb, matcap.rgb * poiFragData.baseColor.rgb, (0.0 /*_MatcapBaseColorMix*/));
				#if defined(PROP_MATCAPMASK) || !defined(OPTIMIZER_ENABLED)
				matcapMask = POI2D_SAMPLER_PAN(_MatcapMask, _MainTex, poiUV(poiMesh.uv[(6.0 /*_MatcapMaskUV*/)], float4(1,1,0,0)), float4(-3,3,0,0))[(0.0 /*_MatcapMaskChannel*/)];
				#else
				matcapMask = 1;
				#endif
				...
				{
					matcap.rgb = hueShift(matcap.rgb, (0.707 /*_MatcapHueShift*/) + _Time.x * (0.0 /*_MatcapHueShiftSpeed*/));
				}
			...
			{
				float3 emission0 = 0;
				float emissionStrength0 = (6.0 /*_EmissionStrength*/);
				...
				{
					emissionColor0 = POI2D_SAMPLER_PAN(_EmissionMap, _MainTex, poiUV(poiMesh.uv[(6.0 /*_EmissionMapUV*/)], float4(1,1,0,0)), float4(1,1,0,0)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.1571495,4.759381,0.3981039,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				else
				{
					emissionColor0 = UNITY_SAMPLE_TEX2D_SAMPLER(_EmissionMap, _MainTex, ((.5 + poiLight.nDotV * .5) * float4(1,1,0,0).xy) + _Time.x * (2.0 /*_EmissionCenterOutSpeed*/)).rgb * lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.1571495,4.759381,0.3981039,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				}
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, (1.0 /*_EmissionBaseColorAsMap*/)).rgb * poiThemeColor(poiMods, float4(0.1571495,4.759381,0.3981039,1).rgb, (0.0 /*_EmissionColorThemeIndex*/));
				#endif
				...
				{
					emissionStrength0 *= calculateBlinkingEmission((0.0 /*_EmissiveBlink_Min*/), (2.0 /*_EmissiveBlink_Max*/), (1.5 /*_EmissiveBlink_Velocity*/), (0.0 /*_EmissionBlinkingOffset*/));
				}
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.lightMap = 1;
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.5523984,1,0.6313685,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.5523984,1,0.6313685,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
				float4 hueShiftAlpha = POI2D_SAMPLER_PAN(_MainColorAdjustTexture, _MainTex, poiUV(poiMesh.uv[(6.0 /*_MainColorAdjustTextureUV*/)], float4(1,1,0,0)), float4(3,3,0,0));
				#else
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), -((2.73 /*_Saturation*/)) * hueShiftAlpha.b);
				poiFragData.baseColor = saturate(poiFragData.baseColor + (-0.107 /*_MainBrightness*/) * hueShiftAlpha.g);
				#endif
				...
				clip(poiFragData.alpha - (0.2 /*_Cutoff*/));
