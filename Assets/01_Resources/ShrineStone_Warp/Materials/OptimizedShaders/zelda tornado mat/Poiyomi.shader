Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/fdf7c236df15a154fa429dd8086d9c72"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyDissolve(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiMods poiMods, in PoiCam poiCam, in PoiLight poiLight)
			{
				...
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiUV(poiMesh.uv[(4.0 /*_DissolveToTextureUV*/)], float4(1,1,0.49,1.06)), float4(0,0,0,0)) * float4(poiThemeColor(poiMods, float4(1,1,1,0.2470588).rgb, (0.0 /*_DissolveTextureColorThemeIndex*/)), float4(1,1,1,0.2470588).a);
				#else
				dissolveToTexture = float4(1,1,1,0.2470588);
				#endif
				#if defined(PROP_DISSOLVENOISETEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				+ (0.0 /*_DissolveAlpha8*/)
				+ (0.0 /*_DissolveAlpha9*/);
				float dds = (0.39 /*_DissolveDetailStrength*/);
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(7.0 /*_DissolveDetailNoiseUV*/)], float4(5,3,0,0)), float4(0,-3,0,0));
				#else
				...
				edgeAlpha = 0;
				[flatten]
				switch((4.0 /*_DissolveType*/))
				{
					default: // Basic (case 1)
					{
						da = remap(da, 0, 1, -(0.17 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						dds *= smoothstep(1, 0.99, da) * lerp(1, smoothstep(0, lerp(0.01, 0.1, dds), da), (0.747 /*_DissolveDetailEdgeSmoothing*/));
						...
						edgeAlpha = remapClamped(da + (0.17 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.17 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.17 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						dds *= smoothstep(0, 0.2*dds + 0.01, dissolveAlpha) * lerp(1, smoothstep(1, 1 - 0.2*dds - 0.01, dissolveAlpha), (0.747 /*_DissolveDetailEdgeSmoothing*/));
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.17 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.17 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
					...
					case 4: // CenterOut
					{
						...
						switch((2.0 /*_CenterOutDissolveMode*/))
						{
							...
							{
								ramp = dot(normalize(float4(-18.35,-7.65,-1.5,0)), lerp(poiMesh.normals[0], poiMesh.normals[1], (0.0 /*_CenterOutDissolveNormals*/)));
						...
						if((5.0 /*_CenterOutDissolvePower*/) != 1)
						{
							ramp = pow(ramp, (5.0 /*_CenterOutDissolvePower*/));
						}
				...
				if ((0.17 /*_DissolveEdgeWidth*/) || ((4.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
					edgeColor = tex2D(_DissolveEdgeGradient, poiUV(float2(edgeAlpha, edgeAlpha), float4(1,1,0,0))) * float4(poiThemeColor(poiMods, float4(0.4520295,1,0.4967654,1).rgb, (0.0 /*_DissolveEdgeColorThemeIndex*/)), float4(0.4520295,1,0.4967654,1).a);
					#ifndef POI_SHADOW
				...
				poiFragData.emission += lerp(0, dissolveToTexture * (1.0 /*_DissolveToEmissionStrength*/), dissolveAlpha) + lerp(0, edgeColor.rgb * (1.42 /*_DissolveEdgeEmission*/), smoothstep(0, 1 - (0.0 /*_DissolveEdgeHardness*/) * .99999999999, edgeAlpha));
				#endif
			}
			#endif
