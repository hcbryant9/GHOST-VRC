Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/bfe0f62752c26e5438aa5cb5e50ae6b8"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISSOLVEMASK) || !defined(OPTIMIZER_ENABLED)
				float dissolveMask = POI2D_SAMPLER_PAN(_DissolveMask, _MainTex, poiUV(poiMesh.uv[(7.0 /*_DissolveMaskUV*/)], float4(1,0.66,0,0)), float4(0,-0.5,0,0)).r;
				#else
				...
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiUV(poiMesh.uv[(4.0 /*_DissolveToTextureUV*/)], float4(1,1,0,0)), float4(0,-0.5,0,0)) * float4(poiThemeColor(poiMods, float4(0.1114872,0,0.00761247,0.2470588).rgb, (0.0 /*_DissolveTextureColorThemeIndex*/)), float4(0.1114872,0,0.00761247,0.2470588).a);
				#else
				dissolveToTexture = float4(0.1114872,0,0.00761247,0.2470588);
				#endif
				#if defined(PROP_DISSOLVENOISETEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(7.0 /*_DissolveDetailNoiseUV*/)], float4(1,1,1,0.07)), float4(0,0,0,0));
				#else
				...
				switch((4.0 /*_DissolveType*/))
				{
					...
					{
						da = remap(da, 0, 1, -(0.104 /*_DissolveEdgeWidth*/), 1);
						dissolveAlpha = da;
						...
						edgeAlpha = remapClamped(da + (0.104 /*_DissolveEdgeWidth*/), da, noise) * (1 - dissolveAlpha);
						break;
					}
					...
					case 3: // Spherical
					{
						...
						{
							da = remap(da, 1, 0, -(0.104 /*_DissolveEdgeWidth*/), 1);
						} else {
							da = remap(da, 0, 1, -(0.104 /*_DissolveEdgeWidth*/), 1);
						}
						dissolveAlpha = da;
						...
						if((0.0 /*_SphericalDissolveInvert*/))
						{
							...
							edgeAlpha = smoothstep((0.104 /*_DissolveEdgeWidth*/) + .00001, 0, -normalizedDistance);
						} else {
							dissolveAlpha = (normalizedDistance < 0) ? 1 : 0;
							edgeAlpha = smoothstep((0.104 /*_DissolveEdgeWidth*/) + .00001, 0, normalizedDistance);
						}
				...
				if ((0.104 /*_DissolveEdgeWidth*/) || ((4.0 /*_DissolveType*/) == 2 && (0.1 /*_DissolveP2PEdgeLength*/) != 0))
				{
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.008023188,0.008023188,0.008023188,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.008023188,0.008023188,0.008023188,1).a;
