Shader "Hidden/Locked/.poiyomi/Poiyomi 8.1/Poiyomi Toon/49e0673681ea06e44a2ebe0ab869c418"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			{
				#if defined(PROP_DISSOLVEMASK) || !defined(OPTIMIZER_ENABLED)
				float dissolveMask = POI2D_SAMPLER_PAN(_DissolveMask, _MainTex, poiUV(poiMesh.uv[(7.0 /*_DissolveMaskUV*/)], float4(1.21,1,0,0)), float4(0,-0.5,0,0)).r;
				#else
				...
				#if defined(PROP_DISSOLVETOTEXTURE) || !defined(OPTIMIZER_ENABLED)
				dissolveToTexture = POI2D_SAMPLER_PAN(_DissolveToTexture, _MainTex, poiUV(poiMesh.uv[(4.0 /*_DissolveToTextureUV*/)], float4(1,1,0,0)), float4(0,-0.5,0,0)) * float4(poiThemeColor(poiMods, float4(0,0.01643899,0.1507121,0.2470588).rgb, (0.0 /*_DissolveTextureColorThemeIndex*/)), float4(0,0.01643899,0.1507121,0.2470588).a);
				#else
				dissolveToTexture = float4(0,0.01643899,0.1507121,0.2470588);
				#endif
				#if defined(PROP_DISSOLVENOISETEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				#if defined(PROP_DISSOLVEDETAILNOISE) || !defined(OPTIMIZER_ENABLED)
				float dissolveDetailNoise = POI2D_SAMPLER_PAN(_DissolveDetailNoise, _MainTex, poiUV(poiMesh.uv[(7.0 /*_DissolveDetailNoiseUV*/)], float4(1,1,1,0.09)), float4(0,0,0,0));
				#else
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.007837884,0.007837884,0.007837884,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.007837884,0.007837884,0.007837884,1).a;
